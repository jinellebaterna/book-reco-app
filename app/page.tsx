...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <nav
        ...
        style={{
          borderColor: "var(--color-border)", backgroundColor:
            "var(--color-card)"
        }}
      >
  ...
  max-w-3xl mx-auto">
        ...
        >
          ...
          <span style={{ color: "var(--color-primary)" }}>recommended by
            AI</span>
        </h1>
        <p className="text-lg mb-10 max-w-xl" style={{
          color:
  ...
  transition-colors hover:opacity-90"
      ...
      {/* Feature Cards */}
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-6 px-8 pb-24
  max-w-4xl mx-auto">
        {[
          {
          ...
          <div
            ...
            style={{
              backgroundColor: "var(--color-card)", borderColor:
                "var(--color-border)"
            }}
          >
